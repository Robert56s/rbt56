/**
 * Filter order and normalized pole calculations, low-pass only. Same
 * derivation as the active-filter tool: a passband edge fp with at most
 ...
 * turned into before the poles can be placed.
 */
